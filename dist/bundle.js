...
var _StateValue = __webpack_require__(18);
...
function StateProxy() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { root: false, debounceTime: 0, withState: false },
      root = _ref.root,
  ...
  return function (WrappedComponent) {
    var ProxiedState = function (_React$Component) {
      ...
      function ProxiedState(props) {
        ...
        _this.throttle = _lodash2.default.throttle(function (fn) {
          return fn();
        }, debounceTime);
        return _this;
      }
      ...
      _createClass(ProxiedState, [{
        ...
        value: function componentDidMount() {
          ...
          if (this.props.name && this.context.addHandler && !this.isControlled() && uncontrolledConfig.getValue && uncontrolledConfig.setValue) {
            this.context.addHandler(this.getCurrentStatePath(), function () {
              return uncontrolledConfig.getValue(_this2.child);
            }, function (value) {
              return uncontrolledConfig.setValue(_this2.child, value);
            });
          }
        }
      }, {
        key: 'getNewPathPart',
        value: function getNewPathPart() {
          var _this3 = this;

          var value = (0, _StateValue.getValue)(this.context.stateValue, this.context.statePath || '');
          if ((typeof value === 'undefined' ? 'undefined' : _typeof(value)) == 'object' && Array.isArray(value)) {
            var index = value.findIndex(function (v) {
              return v.id == _this3.props.name;
            });
        ...
        value: function getCurrentStatePath() {
          if (this.context.statePath && this.context.statePath != '' && this.props.name) return this.context.statePath + '.' + this.getNewPathPart();else if (this.props.name) return this.getNewPathPart();else if (this.context.statePath) return this.context.statePath;else return '';
        }
      }, {
        key: 'isControlled',
        ...
        value: function getStatePathToDispatch() {
          if (root) return '';else return this.getCurrentStatePath();
        }
      }, {
        key: 'getChildContext',
        ...
        value: function render() {
          ...
          if (this.isControlled()) {
            return _react2.default.createElement(WrappedComponent, _extends({}, Object.assign({}, this.props, {
              value: this.context.stateValue ? this.props.value !== undefined ? this.props.value : (0, _StateValue.getValue)(this.context.stateValue, this.getCurrentStatePath()) : this.props.value,
              onChange: this.context.onStateChange ? this.props.onChange !== undefined ? this.props.onChange : function (newValue) {
                return _this4.throttle(function () {
                  return _this4.context.onStateChange((0, _StateValue.setValue)(_this4.context.stateValue, _this4.getCurrentStatePath(), newValue));
                });
              } : this.props.onChange,
              statePath: this.getCurrentStatePath()
            }), { ref: function ref(elem) {
                return _this4.child = elem;
              } }));
          } else {
            return _react2.default.createElement(WrappedComponent, _extends({}, Object.assign({}, this.props, {
              statePath: this.getCurrentStatePath()
    ...
    ProxiedState.contextTypes = {
      ...
      stateValue: _react2.default.PropTypes.any,
  ...
  return function (WrappedComponent) {
    var Controller = function (_React$Component) {
      ...
      function Controller(props) {
        ...
        _this.state = _this._getInitialValue(props);
      ...
      _createClass(Controller, [{
        ...
        key: '_mergeValues',
        value: function _mergeValues() {
          return (0, _immutable.fromJS)(this.state).mergeDeep(this.rootDispatcherGetter ? (0, _immutable.fromJS)(this.rootDispatcherGetter()) : (0, _immutable.fromJS)({}));
        }
      }, {
        key: '_submit',
        value: function _submit() {
          var newValue = this._mergeValues();
        ...
        value: function render() {
          ...
          return _react2.default.createElement(WrappedComponent, _extends({}, this.props, {
            onChange: function onChange(value) {
              return _this3.setState(applyControl(value, _this3.props));
            },
            value: this.state,
            onSubmit: function onSubmit() {
              return _this3._submit();
            }
          }));
        }
      }]);
...
var _StateProxy = __webpack_require__(17);
  ...
  return function (WrappedComponent) {
    var Dispatcher = function (_React$Component) {
      ...
      _createClass(Dispatcher, [{
        ...
        value: function dispatchUncontrolledValues(prevProps) {
          var _this3 = this;
        ...
        value: function getChildContext() {
          ...
          return {
            ...
            onStateChange: function onStateChange(v) {
              _this4.props.onChange(convertOut(v, _this4.props));
            },
            attachToController: null,
            addHandler: function (statePath, getHandler, setHandler) {
              console.log("handler", statePath);
              _this4.handlers = (0, _immutable.fromJS)(_this4.handlers).set(statePath, {
                get: getHandler,
                set: setHandler
              }).toJS();
            }.bind(this)
        ...
        value: function getUncontrolledState() {
          ...
          var value = (0, _immutable.fromJS)(this.handlers).keySeq().reduce(function (red, statePath) {
...
var _FormController = __webpack_require__(22);
...
var _StateDispatcher = __webpack_require__(23);
