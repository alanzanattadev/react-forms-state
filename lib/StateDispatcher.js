    ...
    class Dispatcher extends React.Component {
      ...
      dispatchUncontrolledValues(prevProps) {
        fromJS(this.handlers)
          .keySeq()
          .forEach(statePath => {
            if (prevProps === undefined || !is(fromJS(getValue(convertIn(this.props.value, this.props), statePath)), fromJS(getValue(convertIn(prevProps.value, prevProps), statePath))))
