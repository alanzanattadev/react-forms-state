    ...
    class Dispatcher extends React.Component {
      ...
      dispatchUncontrolledValues(prevProps) {
        fromJS(this.handlers)
          .keySeq()
          .forEach(statePath => {
            if (prevProps === undefined || !is(fromJS(getValue(convertIn(this.props.value), statePath)), fromJS(getValue(convertIn(prevProps.value), statePath))))
              this.handlers[statePath].set(getValue(convertIn(this.props.value), statePath));
          })
      }
