...
export default function StateProxy({root} = {root: false}) {
      ...
      render() {
        return (
          <WrappedComponent {...Object.assign({}, this.props, {
            ...
            onChange: this.context.onStateChange ? newValue => this.context.onStateChange(setValue(this.context.stateValue, this.getCurrentStatePath(), newValue)) : this.props.onChange,
