    ...
    class ProxiedState extends React.Component {
        ...
        this.valueChangeObs = this.parentValueChangeObs
          ...
          .map(e =>
            Object.assign({}, e, {
              ...
              validation: e.validation && e.validation instanceof Validation ? e.validation.getNestedValidation(this.getCurrentStatePath(props, context, e.value)) : e.validation,
            }));
      }
      ...
      componentDidMount() {
        ...
        if (this.valueChangeObs && this.isControlled())
          this.subscription = this.valueChangeObs.subscribe({
            next: e => {
              if (root) {
                this.value = e.value;
