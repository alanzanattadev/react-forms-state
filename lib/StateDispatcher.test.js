...
describe('StateDispatcher', () => {
  ...
  it('should stop propagation when another dispatcher is encountered', () => {
    ...
    expect(subject.find(ProxiedMiniForm).at(0).find(InputField).at(1).prop('value')).toBe('16');
    expect(subject.find(ProxiedMiniForm).at(1).find(InputField).at(0).prop('value')).toBe('february');
    expect(subject.find(ProxiedMiniForm).at(1).find(InputField).at(1).prop('value')).toBe('16');
